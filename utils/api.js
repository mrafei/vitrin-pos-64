export const CDN_BASE_URL = "https://hs3-cf.behtarino.com/static/images/behtarino-web/";
...
export const BUSINESS_WORKING_HOURS_API = (id) => `${BASE_URL}businesses/working_hours/${id}/`;
...
export const POST_IMAGES_ITEM_API = (id) => `${BASE_URL}businesses/images/${id}/`;
export const POST_VIDEOS_API = `${BASE_URL}businesses/videos/`;
export const POST_VIDEOS_ITEM_API = (id) => `${BASE_URL}businesses/videos/${id}/`;
...
export const BUSINESS_CATEGORIES_API = () => `${BASE_URL}deal_categories/by_business/`;
...
export const USER_ORDERS_API = (plugin) => `${BASE_URL}${plugin}_orders/by_business_by_user/`;
export const USER_ORDERS_ITEMS_API = (id, plugin) => `${BASE_URL}${plugin}_orders/${id}/`;
...
export const BUSINESS_ORDERS_SORTED_BY_DELIVERER_API = (plugin, page, pageSize) =>
...
// Plugins API
export const PLUGIN_TRIAL_API = (slug) => `${BASE_URL}businesses/${slug}/enable_plugin_trial/`;
export const PLUGIN_PERSONAL_SITEDOMAIN_API = (slug) =>
  `${BASE_URL}businesses/${slug}/enable_personal_sitedomain/`;
export const BUY_PLUGIN_API = (slug) => `${BASE_URL}businesses/${slug}/buy_plugin_transaction/`;
export const SET_PLUGIN_DATA_API = (slug) => `${BASE_URL}businesses/${slug}/set_plugin_data/`;
...
export const GET_ORDER_TRANSACTION_API = (id) => `${BASE_URL}order_transactions/${id}/`;

export const TRANSACTION_ZIBAL_API = (id) => `${BASE_URL}order_transactions/${id}/pay_transaction/`;
export const TRANSACTION_API = (id, gateway) => `${BASE_URL}transactions/${id}/${gateway}_gateway`;
...
export const VITRIN_PAGE_VIEWS_API = (slug) => `${BASE_URL}businesses/${slug}/vitrin_page_views/`;

export const SUBMIT_REVIEW_API = `${BASE_URL}reviews/`;
export const GET_BUSINESS_REVIEWS_API = (slug) => `${BASE_URL}businesses/${slug}/reviews/`;
