...
const CustomMap = ({
  ...
  const icon = index =>
    new DivIcon({
      html: `<div style="width: 25.6px; height: 40.75px; background: url(${CDN_BASE_URL}${markerUrl}) ${calculateMarkerPosition(
        index,
      )}; background-size: 255px 163px; margin-top: -34.75px !important;margin-right: -7px !important;"></div>`,
