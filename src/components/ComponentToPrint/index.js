      ...
      <div className="bg-white w-100 u-text-black printable px-3 u-fontVerySmall">
        ...
        <div className="d-flex flex-column justify-content-between px-3 pb-1">
          ...
          <div className="mt-1">
            ...
            {order.user_address && (
              <span className="u-fontWeightBold u-fontSemiLarge">{order.user_address.address}</span>
            )}
          </div>
          <div className="mt-1">
            <span>تلفن: </span>
        ...
        <div className="d-flex flex-column justify-content-between px-3 pb-1 u-border-bottom-dark">
          ...
          <div className="mt-1">
            ...
            <span className="u-fontWeightBold" style={{ whiteSpace: "pre-wrap" }}>
              {priceFormatter(order.total_initial_price - order.final_price_without_delivery)} تومان
            </span>
          </div>
          <div className="mt-1">
