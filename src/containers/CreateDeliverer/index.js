...
export function CreateDeliverer({
  ...
  const addDeliverer = useCallback(() => {
    ...
    _setPluginData('food', {...pluginData.data, deliverers: [...deliverers, {name, phone}]})
      ...
      <div
        ...
        <div className="d-flex flex-1 u-background-white px-5 flex-column">
          ...
          <div className="d-flex flex-1">
            ...
            />
            <Input onChange={value => setPhone(persianToEnglishNumber(value))}
                   numberOnly
                   className="col-10 mt-4"
          ...
          <div className="d-flex mb-5">
            <PrimaryButton text="تایید و ذخیره" disabled={!phone || !name} className="u-w-auto px-5 u-fontWeightBold"
                           isLoading={loading}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    _setPluginData: (pluginName, data) =>
      dispatch(setPluginData(pluginName, data, 'پیک با موفقیت افزوده شد.', 'در افزودن پیک خطایی رخ داده است!')),
  };
}
