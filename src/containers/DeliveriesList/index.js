        ...
        <div className="d-flex text-center px-60 py-3">
          ...
          >
            {deliverers.map(d => <span
              ...
              className={`ml-1 u-cursor-pointer u-border-radius-68 px-2 py-1 u-no-wrap ${deliverer.name === d.name ? 'u-text-black u-fontWeightBold u-background-white badge-shadow' : 'u-text-dark-grey'}`}>
            {d.name}
          </span>)}
          </Flickity>
        </div>
