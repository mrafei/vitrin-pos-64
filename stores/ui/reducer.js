...
import {
  ...
  LOGIN_MODAL,
  VERIFICATION_MODAL,
  FOOD_ORDER_PREVIEW_DRAWER,
  FOOD_USER_ADDRESSES_DRAWER,
  FOOD_USER_LOCATION_DRAWER,
  FOOD_USER_NEW_ADDRESS_DRAWER,
  FOOD_INVOICE_DRAWER,
  SET_UI_PRODUCT,
  SET_UI_POST,
  ADMIN_MENU,
  ...
  ECOMMERCE_ORDER_PREVIEW_DRAWER,
  ECOMMERCE_USER_ADDRESSES_DRAWER,
  ECOMMERCE_USER_LOCATION_DRAWER,
  ECOMMERCE_USER_NEW_ADDRESS_DRAWER,
  ECOMMERCE_INVOICE_DRAWER,
...
export const initialState = {
  ...
  drawers: {
    [FOOD_ORDER_PREVIEW_DRAWER]: false,
    [FOOD_USER_ADDRESSES_DRAWER]: false,
    [FOOD_USER_LOCATION_DRAWER]: false,
    [FOOD_USER_NEW_ADDRESS_DRAWER]: false,
    [FOOD_INVOICE_DRAWER]: false,
    [ECOMMERCE_ORDER_PREVIEW_DRAWER]: false,
    [ECOMMERCE_USER_ADDRESSES_DRAWER]: false,
    [ECOMMERCE_USER_LOCATION_DRAWER]: false,
    [ECOMMERCE_USER_NEW_ADDRESS_DRAWER]: false,
    [ECOMMERCE_INVOICE_DRAWER]: false,
    [ECOMMERCE_SUBMITED_ORDERS_DRAWER]: false,
    [ADMIN_MENU]: false,
  },
  product: null,
  post: null,
